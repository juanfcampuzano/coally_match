...
class MongoDBHandler:
    def __init__(self):
        ...
        self.put_connection = MongoClient(self.put_uri)
        self.read_connection = MongoClient(self.read_uri)
    ...
    def get_project(self, project_id):
        ...
        found_project = self.read_connection[self.app_database_name][self.projects_collection_name].find_one(query)
    ...
    def get_resume(self, resume_id):
        ...
        found_cv = self.read_connection[self.app_database_name][self.resumes_collection_name].find_one(query)
    ...
    def upsert_parsed_document(self, document, collection):
        ...
        result = self.put_connection[self.ml_database_name][collection_name].update_one(query, {"$set": document}, upsert=True)
    ...
    def find_documents_with_matching_items(self, collection, search_list):
        ...
        result = self.read_connection[self.ml_database_name][collection_name].find(query)
        return result
